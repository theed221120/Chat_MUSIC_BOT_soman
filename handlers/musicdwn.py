...
@Client.on_message(filters.command(['yts', 'yst@Music_for_hsk_bot ']))
...
@Client.on_message(filters.command(["saavn", "saavn@Music_for_hsk_bot "]) & ~filters.edited)
@capture_err
...
@Client.on_message(filters.command(["deezer", "deezer@Music_for_hsk_bot "]) & ~filters.edited)
@capture_err
...
@Client.on_message(filters.command(["lyrics", "lyrics@Music_for_hsk_bot "]))
...
@Client.on_message(filters.command(["ytvid", "ytvid@Music_for_hsk_bot "]))
